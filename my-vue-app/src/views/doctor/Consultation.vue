  ...
  <div class="min-h-screen bg-gray-50">
    <div class="container mx-auto p-6">
      ...
      <div v-else class="space-y-6">
        <!-- Patient Information Card with improved styling -->
        <div class="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div class="p-5">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <p class="font-medium text-gray-800 text-lg">{{ appointment?.patient_id }}</p>
              </div>
              <div class="bg-gray-50 p-4 rounded-lg">
                <p class="text-gray-500 text-sm mb-1">Patient Name</p>
                <p class="font-medium text-gray-800 text-lg">{{ patient?.patient_name }}</p>
              </div>
              <div class="bg-gray-50 p-4 rounded-lg">
              ...
              <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <div v-if="patientAllergies.length" class="flex flex-wrap gap-2 mt-1">
          ...
          <div v-if="warning" class="mx-5 mb-5 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
            <div class="flex">
              ...
              <div class="ml-3">
                <p class="text-yellow-700">{{ warning }}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="p-5">
            <div class="space-y-3">
              <div v-for="note in appointment.notes" :key="note.diagnosis" 
                ...
                <span class="font-medium text-gray-800">{{ note.diagnosis }}</span>
                <div class="flex items-center">
                  <div class="w-32 bg-gray-200 rounded-full h-2.5 mr-2">
                    <div class="bg-purple-600 h-2.5 rounded-full" :style="`width: ${note.confidence}%`"></div>
                  </div>
                  <span class="text-sm font-medium text-gray-600">{{ note.confidence }}%</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- Consultation Form with improved styling -->
        <div class="bg-white rounded-lg shadow overflow-hidden">
      ...
      <!-- Success / Error Popup with improved styling -->
      ...
      <!-- Leave Confirmation Modal with improved styling -->
