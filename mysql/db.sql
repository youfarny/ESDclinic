...
CREATE TABLE `patient`.`patient` (
  ...
  `patient_allergies` LONGTEXT NOT NULL,
...
INSERT INTO `patient`.`patient` (patient_name, patient_password, patient_contact, patient_address, insurance, patient_allergies)
VALUES 
...
INSERT INTO `appointments`.`appointment` (patient_id, patient_symptoms, notes, diagnosis, doctor_id, prescription_id, payment_id, start_time, end_time)
VALUES 
...
INSERT INTO `payment`.`payment` (payment_id, appointment_id, status, payment_amount)
VALUES 
(1, 1, 1, '100.00'),
(2, 2, 1, '150.00'),
(3, 3, 0, '200.00'),
