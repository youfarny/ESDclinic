    ...
    <div v-else class="appointments-list">
      <div v-for="(appointment, index) in appointments" :key="index" class="appointment-card">
        ...
        <div class="appointment-actions">
          <button class="btn-primary" @click="proceedToPay(appointment)">Pay Now</button>
        </div>
      </div>
    </div>
  </div>
...
<script>
import NavigationBar from '../../components/patient/NavigationBar.vue'; // Adjust path as needed
