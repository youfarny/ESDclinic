...
# Database Config
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:ESD213password!@202.166.134.237:3306/queue'
...
swagger = Swagger(app, template={
    "swagger": "2.0",
    "info": {
        "title": "SMUDOC Queue API",
        "description": "API documentation for managing appointment queues in SMUDOC",
        "version": "1.0.0"
    },
    "basePath": "/",
    "schemes": ["http"],
    "definitions": {
        "Queue": {
            ...
            "required": ["doctor_id", "patient_contact"]
        }
    },
    "tags": [
        {
            "name": "Queue",
            "description": "Operations related to appointment queue management"
        }
    ]
})
